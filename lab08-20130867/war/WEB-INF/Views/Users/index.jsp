...
<table class="table table-hover">
    ...
    <%for( User p : personas ) {%>
      <tr class="info">
        ...
        <td>
        <div class="Cell">
        <input type="submit" class="btn btn-default" class="form-control" name="edit" value=<%="Edit-"+c%> />
        <input type="submit" class="btn btn-default" class="form-control" name="del" value=<%="Del-"+c%>  /></div>
        </td>
      </tr>
      <%c++; %>
      <%}%>
